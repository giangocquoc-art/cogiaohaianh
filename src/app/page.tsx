...
function ViewRenderer() {
  ...
  const getTransitionVariants = (view: string) => {
    switch (view) {
      case 'quiz':
        // Slide in from right - entering quiz feels decisive
        return {
      ...
      case 'result':
        // Scale up with bounce - results are exciting
        return {
      ...
      default:
        // Current default animation for other views
        return {
  ...
  const variants = getTransitionVariants(currentView)
